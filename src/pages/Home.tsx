...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      {/* Hero Section */}
      <nav className="sticky top-0 z-50 bg-gradient-to-r from-white to-slate-50 dark:bg-gradient-to-r dark:from-gray-900 dark:to-gray-800 shadow-xl border-b border-gray-200/50 dark:border-gray-700/50 transition-all duration-300">
        <div className="container mx-auto px-6 py-5 flex justify-between items-center">
          <div className="flex items-center">
            <div className="p-2 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 shadow-lg">
              <Lock className="h-10 w-10 text-white" />
            </div>
            <span className="ml-4 text-3xl font-bold text-gray-800 dark:text-white">
              SENASEC
            </span>
          </div>
          {/* Desktop Controls */}
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-gradient-to-br from-white to-slate-50 dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-900 p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-200/50 dark:border-gray-700/50 transform hover:scale-105"
                >
                  <div className="inline-flex items-center justify-center p-4 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl text-white shadow-lg mb-6">
        ...
        <section
          id="advantages"
          className="py-16 md:py-24 bg-blue-100 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 rounded-3xl mx-4"
        >
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-800 dark:text-white mb-6">
              {t("systemAdvantages")}
